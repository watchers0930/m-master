...
- 본문 텍스트 **2,000~3,500자** (공백 포함)
- 목표: **2,400자 내외** (네이버 D.I.A.+ 체류 시간·공유율 피크 구간)
- 1,500자 미만: 저품질 판정 위험 — 절대 미달 금지
- 5,000자 초과: 이탈률 상승 — 내용 늘리기 위한 반복 서술 금지
- 각 H2 섹션: 본문 **최소 200자** (bullet 나열만으로 채우기 금지)
...
### 소제목
- H2: **5~7개**, 각 H2마다 세부 키워드 1개 자연스럽게 포함
...
채점 기준:
- seo(0~100): 핵심 키워드가 제목·첫 문단·결론에 포함됐는가 / H2 5~7개 / 목차 존재 / 글자수 2,000~3,500자 / 롱테일 키워드 2개 이상 / 이미지 플레이스홀더 6개 이상
