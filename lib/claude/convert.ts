...
## 규칙 (네이버 스팸 필터 회피 필수)
- 총 300~500자, 자연스러운 대화체 (카페 글 느낌)
- 마크다운 기호(##, **, -, > 등) 절대 사용 금지 — 순수 텍스트만
- HTML 태그 사용 금지
- 번호 목록(1. 2. 3.) 사용 금지 — 스팸으로 감지됨
- 해시태그(#키워드) 사용 금지 — 스팸으로 감지됨
- 친근하고 자연스러운 톤 ("~거든요", "~인데요", "~하세요")
- 어려운 부동산·법률 용어는 풀어서 설명
- 핵심 정보를 자연스러운 문단 흐름으로 전달
- VESTRA 직접 언급 대신 "AI 분석 서비스" 정도로 자연스럽게 1회 언급
- 광고성 CTA("무료 분석", "바로가기", "링크") 사용 금지

## 출력 형식
순수 텍스트 본문만 출력 (300~500자)
설명·JSON·코드블록·해시태그 없이 본문만 출력하세요.`,
};
